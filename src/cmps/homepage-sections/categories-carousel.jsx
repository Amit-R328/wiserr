...
export const CategoriesCarousel = () => {
    ...
    return (
        <div className="slider-container">
            <div className="slide1" onClick={() => onChangeCategory('Graphics & Design')}>
                <h4 className="category-legends">
                    <small>Build your brand</small><br></br>Logo Design</h4>
            ...
            <div className="slide2" onClick={() => onChangeCategory('Digital Marketing')}>
                <h4 className="category-legends">
                    <small>Customize your site</small><br></br>WordPress</h4>
            ...
            <div className="slide3" onClick={() => onChangeCategory('Music & Audio')}>
                <h4 className="category-legends">
                    <small>Share your message</small><br></br>Voice Over</h4>
            ...
            <div className="slide4" onClick={() => onChangeCategory('Video & Animation')}>
                <h4 className="category-legends">
                    <small>Engage your audience</small><br></br>Video Explainer</h4>
            ...
            <div className="slide5" onClick={() => onChangeCategory('Digital Marketing')}>
                <h4 className="category-legends">
                    <small>Reach more customers</small><br></br>Social Media</h4>
